...
export const translations: Translation = {
  ...
  'searchPanels': { zh: '搜索面板...', en: 'Search panels...' },
  'filters': { zh: '筛选', en: 'Filters' },
  'filterByType': { zh: '按类型', en: 'By Type' },
  'filterBySection': { zh: '按分组', en: 'By Section' },
  'filterByHealth': { zh: '按状态', en: 'By Health' },
  'clearFilters': { zh: '清除筛选', en: 'Clear Filters' },
  'sortByPosition': { zh: '按位置排序', en: 'By Position' },
  'sortByTitle': { zh: '按标题排序', en: 'By Title' },
  'sortByType': { zh: '按类型排序', en: 'By Type' },
  'sortByValue': { zh: '按当前值排序', en: 'By Current Value' },
  'sortByHealth': { zh: '按健康状态排序', en: 'By Health' },
  'ascending': { zh: '升序', en: 'Ascending' },
  'descending': { zh: '降序', en: 'Descending' },
  'healthy': { zh: '正常', en: 'Healthy' },
  'warning': { zh: '警告', en: 'Warning' },
  'error': { zh: '错误', en: 'Error' },
  'currentValue': { zh: '当前值', en: 'Current' },
  'health': { zh: '状态', en: 'Health' },
  'section': { zh: '分组', en: 'Section' },
  'copyQuery': { zh: '复制查询', en: 'Copy Query' },
  'copied': { zh: '已复制', en: 'Copied' },
  'expand': { zh: '展开', en: 'Expand' },
  'collapse': { zh: '收起', en: 'Collapse' },
  'noMatchingPanels': { zh: '无匹配面板', en: 'No matching panels' },
};
